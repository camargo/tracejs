describe("Camera Class", function() {
    it("Constructs a camera class", function() {
		...
		expect(cam1.up).toEqual(new Tracejs.Vector3D(0,1,0));
		expect(cam1.u).toEqual(new Tracejs.Vector3D(1,0,0));
		expect(cam1.v).toEqual(new Tracejs.Vector3D(0,1,0));
		expect(cam1.w).toEqual(new Tracejs.Vector3D(0,0,1));
    });
